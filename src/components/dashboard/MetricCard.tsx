...
export function MetricCardView({ metric }: MetricCardProps) {
  ...
  return (
    <div className="group rounded-xl border border-slate-200 bg-white p-4 shadow-card transition-shadow hover:shadow-md">
      <div className="flex items-start justify-between gap-3">
        ...
        <span className={`inline-flex shrink-0 items-center gap-0.5 rounded-full px-2 py-1 text-xs font-semibold ${pill}`}>
